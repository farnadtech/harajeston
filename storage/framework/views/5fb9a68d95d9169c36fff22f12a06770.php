...
<?php $__env->startSection('page-subtitle', 'مدیریت اطلاعات و تصاویر فروشگاه'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <?php if($store->pending_store_name): ?>
            <div class="bg-yellow-100 border border-yellow-400 text-yellow-800 px-4 py-3 rounded-lg mb-4">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-sm mt-1">نام جدید: <strong><?php echo e($store->pending_store_name); ?></strong></p>
                        <p class="text-xs text-yellow-700 mt-1">تاریخ درخواست: <?php echo e(\Morilog\Jalali\Jalalian::fromCarbon($store->store_name_change_requested_at)->format('Y/m/d H:i')); ?></p>
                    </div>
                </div>
            </div>
        <?php endif; ?>
        ...
        <form action="<?php echo e(route('stores.update')); ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="store_name" value="<?php echo e(old('store_name', $store->store_name)); ?>"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" required>
                <?php if($store->pending_store_name): ?>
                    <p class="text-xs text-gray-500 mt-1">نام فعلی: <?php echo e($store->store_name); ?> | در انتظار تایید: <?php echo e($store->pending_store_name); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4"
                          class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"><?php echo e(old('description', $store->description)); ?></textarea>
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">آدرس</label>
                <textarea name="address" rows="2"
                          class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"><?php echo e(old('address', $store->address)); ?></textarea>
            </div>

            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">تلفن</label>
                    <input type="text" name="phone" value="<?php echo e(old('phone', $store->phone)); ?>"
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">ایمیل</label>
                    <input type="email" name="email" value="<?php echo e(old('email', $store->email)); ?>"
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <?php if($store->logo_image): ?>
            <div class="mb-4">
                <img src="<?php echo e(url('storage/' . $store->logo_image)); ?>" alt="Logo" class="w-32 h-32 object-cover rounded-lg">
            </div>
        <?php endif; ?>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <?php if($store->banner_image): ?>
            <div class="mb-4">
                <img src="<?php echo e(url('storage/' . $store->banner_image)); ?>" alt="Banner" class="w-full h-48 object-cover rounded-lg">
            </div>
        <?php endif; ?>
