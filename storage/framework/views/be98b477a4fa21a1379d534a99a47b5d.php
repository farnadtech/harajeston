...
<div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 sm:p-12">
    ...
    <form action="<?php echo e(route('password.otp.reset')); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?>
    ...
    <div class="mb-8 text-center">
        ...
        <p class="text-sm text-gray-500">کد 6 رقمی ارسال شده به <span class="font-bold text-gray-700 mx-1" dir="ltr"><?php echo e($identifier); ?></span> را وارد کنید</p>
    </div>
    <form action="<?php echo e(route('password.otp.verify')); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="identifier" value="<?php echo e($identifier); ?>">
        <div>
    ...
    <form id="resend-form" action="<?php echo e(route('password.otp.send')); ?>" method="POST" class="hidden"><?php echo csrf_field(); ?><input type="hidden" name="identifier" value="<?php echo e($identifier); ?>"></form>
    <div class="mt-4 text-center"><a href="<?php echo e(route('password.request')); ?>" class="text-sm text-gray-500 hover:text-gray-700">تغییر شماره/ایمیل</a></div>
    <script>
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\auth\password-reset-otp.blade.php ENDPATH**/ ?>