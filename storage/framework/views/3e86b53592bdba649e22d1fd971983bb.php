...
<head>
    ...
    <title>داشبورد فروشنده - <?php echo e(config('app.name')); ?></title>
    ...
    <main class="flex-1 lg:mr-64 flex flex-col h-screen overflow-hidden relative w-full">
        ...
        <header class="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-8 shrink-0">
            <div class="hidden lg:block">
                <h2 class="text-xl font-bold text-gray-800">خوش آمدید، <?php echo e(optional(auth()->user()->store)->store_name ?? auth()->user()->name); ?> 👋</h2>
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/dashboard/seller-new.blade.php ENDPATH**/ ?>