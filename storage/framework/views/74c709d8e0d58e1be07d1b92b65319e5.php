...
<head>
    ...
    ?>
    <title><?php echo $__env->yieldContent('title', 'داشبورد مدیریت'); ?><?php echo e($titleSuffix); ?></title>
    <?php if($faviconUrl): ?>
...
<body class="bg-background-light text-[#0d121b] antialiased min-h-screen flex overflow-hidden">
    ...
    <aside id="app-sidebar"
           ...
           style="background:<?php echo e(\App\Models\SiteSetting::get('theme_dashboard_sidebar_bg', '#ffffff')); ?>;">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-0.5">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                      <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                <span class="material-symbols-outlined text-[20px]">dashboard</span>
                <span class="text-sm">داشبورد</span>
            </a>

            
            <div x-data="{ open: <?php echo e($isAuctionGroup ? 'true' : 'false'); ?> }">
                ...
                <div x-show="open" class="space-y-0.5 pr-3">
                    <a href="<?php echo e(route('admin.listings.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.listings.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">sell</span>
                        <span>مدیریت آگهی‌ها</span>
                    </a>
                    <a href="<?php echo e(route('admin.categories.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.categories.*') || request()->routeIs('admin.category-attributes.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
            ...
            <div x-data="{ open: <?php echo e($isUsersGroup ? 'true' : 'false'); ?> }">
                <button @click="open = !open"
                        class="w-full flex items-center gap-3 px-3 py-2 mt-3 text-xs font-bold text-gray-400 uppercase tracking-wider hover:text-gray-600 transition-colors">
                ...
                <div x-show="open" class="space-y-0.5 pr-3">
                    <a href="<?php echo e(route('admin.users.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.users.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">manage_accounts</span>
                        <span>مدیریت کاربران</span>
                    </a>
                    <a href="<?php echo e(route('admin.sellers.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.sellers.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">storefront</span>
                        <span>فروشندگان</span>
                        <?php $pendingSellersCount = \App\Models\User::where('seller_status', 'pending')->count(); ?>
                        <?php if($pendingSellersCount > 0): ?>
                            <span class="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full mr-auto"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($pendingSellersCount); ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('admin.store-name-requests.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.store-name-requests.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">edit_note</span>
                        <span>تغییر نام فروشگاه</span>
                        <?php $pendingStoreNameCount = \App\Models\Store::whereNotNull('pending_store_name')->count(); ?>
                    ...
                    <a href="<?php echo e(route('admin.seller-reviews.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.seller-reviews.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">rate_review</span>
                        <span>نظرات فروشندگان</span>
                        <?php $pendingReviewsCount = \App\Models\SellerReview::pending()->count(); ?>
                        <?php if($pendingReviewsCount > 0): ?>
                            <span class="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full mr-auto"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($pendingReviewsCount); ?></span>
                        <?php endif; ?>
                    </a>
                </div>
            </div>
            ...
            <div x-data="{ open: <?php echo e($isOrdersGroup ? 'true' : 'false'); ?> }">
                <button @click="open = !open"
                        class="w-full flex items-center gap-3 px-3 py-2 mt-3 text-xs font-bold text-gray-400 uppercase tracking-wider hover:text-gray-600 transition-colors">
                ...
                <div x-show="open" class="space-y-0.5 pr-3">
                    <a href="<?php echo e(route('admin.orders.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">shopping_bag</span>
                        <span>سفارشات</span>
                    </a>
                    <a href="<?php echo e(route('admin.financial-reports.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.financial-reports.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">bar_chart</span>
                        <span>گزارشات مالی</span>
                    </a>
                    <a href="<?php echo e(route('admin.withdrawals.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.withdrawals.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">account_balance</span>
                        <span>درخواست‌های برداشت</span>
                        <?php $pendingWithdrawCount = \App\Models\WithdrawalRequest::where('status','pending')->count(); ?>
                        <?php if($pendingWithdrawCount > 0): ?>
                            <span class="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full mr-auto"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($pendingWithdrawCount); ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('admin.shipping-methods.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.shipping-methods.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">local_shipping</span>
                        <span>روش‌های ارسال</span>
                    </a>
                    <a href="<?php echo e(route('admin.payment-gateways.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.payment-gateways.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
            ...
            <div x-data="{ open: <?php echo e($isSupportGroup ? 'true' : 'false'); ?> }">
                <button @click="open = !open"
                        class="w-full flex items-center gap-3 px-3 py-2 mt-3 text-xs font-bold text-gray-400 uppercase tracking-wider hover:text-gray-600 transition-colors">
                ...
                <div x-show="open" class="space-y-0.5 pr-3">
                    <a href="<?php echo e(route('admin.tickets.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.tickets.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">confirmation_number</span>
                        <span>تیکت‌های پشتیبانی</span>
                        <?php $openTickets = \App\Models\Ticket::where('status', 'open')->count(); ?>
                        <?php if($openTickets > 0): ?>
                            <span class="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full mr-auto"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($openTickets); ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('admin.comments.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.comments.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">help</span>
                        <span>پرسش‌های محصولات</span>
                        <?php $pendingCommentsCount = \App\Models\ListingComment::pending()->whereNull('parent_id')->count(); ?>
                        <?php if($pendingCommentsCount > 0): ?>
                            <span class="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full mr-auto"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($pendingCommentsCount); ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('admin.newsletter.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.newsletter.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
            ...
            <div x-data="{ open: <?php echo e($isSettingsGroup ? 'true' : 'false'); ?> }">
                <button @click="open = !open"
                        class="w-full flex items-center gap-3 px-3 py-2 mt-3 text-xs font-bold text-gray-400 uppercase tracking-wider hover:text-gray-600 transition-colors">
                ...
                <div x-show="open" class="space-y-0.5 pr-3">
                    <a href="<?php echo e(route('admin.settings.general')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.settings.general') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">tune</span>
                        <span>تنظیمات عمومی</span>
                    </a>
                    <a href="<?php echo e(route('admin.settings.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.settings.index') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">manage_history</span>
                        <span>تنظیمات سیستم</span>
                    </a>
                    <a href="<?php echo e(route('admin.homepage.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.homepage.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">dashboard_customize</span>
                        <span>صفحه اصلی</span>
                    </a>
                    <a href="<?php echo e(route('admin.theme.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.theme.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">style</span>
                        <span>هدر و فوتر</span>
                    </a>
                    <a href="<?php echo e(route('admin.pages.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.pages.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">article</span>
                        <span>مدیریت صفحات</span>
                    </a>
                    <a href="<?php echo e(route('admin.notification-settings.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.notification-settings.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                        <span class="material-symbols-outlined text-[18px]">notifications_active</span>
                        <span>تنظیمات اعلان‌ها</span>
                    </a>
                    <a href="<?php echo e(route('admin.sms-gateways.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.sms-gateways.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
                    ...
                    <a href="<?php echo e(route('admin.update.index')); ?>"
                       class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm
                              <?php echo e(request()->routeIs('admin.update.*') ? 'bg-primary/10 text-primary font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium'); ?>">
    ...
    <main class="flex-1 lg:mr-64 flex flex-col h-screen overflow-hidden relative w-full">
        ...
        <header class="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-8 shrink-0">
            <div class="flex items-center gap-3">
                ...
                <div class="lg:hidden">
                    <h1 class="text-base font-bold text-gray-900"><?php echo $__env->yieldContent('page-title', 'داشبورد'); ?></h1>
                </div>
                <div class="hidden lg:block">
                <h2 class="text-xl font-bold text-gray-800"><?php echo $__env->yieldContent('header-title', 'خوش آمدید، ادمین عزیز 👋'); ?></h2>
                <p class="text-sm text-gray-500"><?php echo $__env->yieldContent('header-subtitle', 'گزارش کلی وضعیت بازار امروز'); ?></p>
            </div>
            </div>
            ...
            <div class="flex items-center gap-4">
                    ...
                    <div x-show="open" 
                        ...
                        <div class="max-h-96 overflow-y-auto">
                            ...
                            <template x-for="notification in notifications" :key="notification.id">
                                <a :href="notification.link ? '<?php echo e(route('admin.notifications.read', '')); ?>/' + notification.id : '#'" 
                        ...
                        <div class="px-4 py-3 border-t border-gray-200 text-center">
                            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="text-sm text-primary hover:text-blue-700 font-medium">مشاهده همه اعلان‌ها</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" 
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 hover:bg-gray-50 transition-colors">
                            <span class="material-symbols-outlined text-gray-500 text-xl">home</span>
                            <span class="text-sm">بازگشت به سایت</span>
                        </a>
                        
                        <a href="<?php echo e(route('wallet.show')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 hover:bg-gray-50 transition-colors">
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/layouts/admin.blade.php ENDPATH**/ ?>