            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <?php if($order->status === 'pending' && $order->buyer_id === auth()->id()): ?>
                    <div class="bg-orange-50 border-2 border-orange-200 rounded-lg p-6">
                        ...
                        <form action="<?php echo e(route('orders.updateShippingAddress', $order)); ?>" method="POST" class="space-y-4">
                            <?php echo csrf_field(); ?>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-2">استان *</label>
                                    <input type="text" name="shipping_state" value="<?php echo e(old('shipping_state')); ?>" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="shipping_phone" value="<?php echo e(old('shipping_phone')); ?>" 
                                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                ...
                <?php if($order->shipping_address): ?>
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="space-y-2 text-gray-700">
                            <p><strong>استان:</strong> <?php echo e($order->shipping_state); ?></p>
                            <p><strong>شهر:</strong> <?php echo e($order->shipping_city); ?></p>
                            <p><strong>آدرس:</strong> <?php echo e($order->shipping_address); ?></p>
                            <p><strong>کد پستی:</strong> <?php echo e($order->shipping_postal_code); ?></p>
                            <p><strong>شماره تماس:</strong> <?php echo e($order->shipping_phone); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <div class="space-y-6">
                ...
                <?php if($order->buyer_id === auth()->id() && $order->status === 'shipped'): ?>
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <?php $orderListing = $order->items->first()?->listing; ?>
                        <?php if($orderListing): ?>
                        <a href="<?php echo e(route('tickets.create', ['listing_id' => $orderListing->id])); ?>"
...
function showCancelOrderModal(userType) {
    ...
    const penaltyValue = parseFloat('<?php echo e(\App\Models\SiteSetting::get("order_cancellation_penalty_value", 10)); ?>');
