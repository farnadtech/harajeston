            ...
            <?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                >
                    ...
                    <div class="relative aspect-[4/3] bg-gray-100 overflow-hidden">
                        <?php if($tab === 'active' && $listing->ends_at && $listing->ends_at->isFuture() && $listing->ends_at->diffInHours() < 6): ?>
                        ...
                        <?php if($tab === 'upcoming' && $listing->starts_at): ?>
                            <div class="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/60 to-transparent">
                                <div class="flex items-center justify-center gap-1 text-white font-bold text-sm bg-black/40 backdrop-blur-sm rounded-lg py-1.5 mx-8 border border-white/10">
                                    ...
                                    ?>
                                    <span><?php echo e($startLabel); ?></span>
                                </div>
                            </div>
                        <?php elseif($tab === 'active' && $listing->ends_at && $listing->ends_at->isFuture()): ?>
                            <div class="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/60 to-transparent">
                                <div class="flex items-center justify-center gap-1 text-white font-bold text-sm bg-black/40 backdrop-blur-sm rounded-lg py-1.5 mx-8 border border-white/10">
                    ...
                    <div class="p-4 flex flex-col flex-1">
                        ...
                        <div class="mt-auto pt-4 border-t border-gray-50">
                            ...
                            <?php if($listing->hasBuyNowPrice() && $tab === 'active'): ?>
