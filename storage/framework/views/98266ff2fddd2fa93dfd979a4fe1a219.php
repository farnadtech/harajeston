...
<?php $__env->startSection('title', 'ایجاد حراجی جدید'); ?>
...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    ...
    <form action="<?php echo e(route('admin.listings.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
            ...
            <div>
                ...
                <select name="seller_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    ...
                    <?php $__currentLoopData = \App\Models\User::where('role', 'seller')->orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($seller->id); ?>" <?php echo e(old('seller_id') == $seller->id ? 'selected' : ''); ?>>
                            <?php echo e($seller->name); ?> (<?php echo e($seller->email); ?>)
                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <?php else: ?>
                <p class="text-sm text-gray-500">هیچ روش ارسالی تعریف نشده است. <a href="<?php echo e(route('admin.shipping-methods.create')); ?>" class="text-primary hover:underline">ایجاد روش ارسال</a></p>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select name="status" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    <option value="pending" <?php echo e(old('status') === 'pending' ? 'selected' : ''); ?>>در انتظار</option>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex gap-3 mt-6">
            ...
            <a href="<?php echo e(route('admin.listings.index')); ?>" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors font-medium">
                انصراف
            </a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/admin/listings/create.blade.php ENDPATH**/ ?>