...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <form action="<?php echo e(route('checkout.auction.process', $listing)); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="flex gap-4">
                        ...
                        <?php endif; ?>
                        <div class="flex-1">
                            <h3 class="font-bold text-gray-900"><?php echo e($listing->title); ?></h3>
                            <p class="text-sm text-gray-600 mt-1">مبلغ برنده شده: <?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($totalAmount))); ?> تومان</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="shipping_address" rows="3"
                                      ...
                                      placeholder="آدرس کامل خود را وارد کنید"><?php echo e(old('shipping_address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="shipping_postal_code" value="<?php echo e(old('shipping_postal_code')); ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="shipping_phone" value="<?php echo e(old('shipping_phone', auth()->user()->phone)); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <?php if($shippingMethods->isEmpty()): ?>
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = $shippingMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <label class="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-primary transition-colors">
                                    <input type="radio" name="shipping_method_id" value="<?php echo e($method->id); ?>" 
                                           data-cost="<?php echo e($cost); ?>"
                                           class="w-5 h-5 text-primary" 
                                           <?php echo e(old('shipping_method_id') == $method->id ? 'checked' : ''); ?>

                                           onchange="updateTotal()">
                                    <div class="flex-1">
                                        <div class="font-bold text-gray-900"><?php echo e($method->name); ?></div>
                                        <?php if($method->description): ?>
                                            <div class="text-sm text-gray-600 mt-1"><?php echo e($method->description); ?></div>
                                        <?php endif; ?>
                                        <div class="text-sm text-gray-500 mt-1">
                                            زمان تحویل: <?php echo e(\App\Services\PersianNumberService::convertToPersian($method->estimated_days)); ?> روز کاری
                                        </div>
                                    </div>
                                    <div class="font-bold text-primary">
                                        <?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($cost))); ?> تومان
                                    </div>
                                </label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <button type="submit" 
                        ...
                        <?php echo e($shippingMethods->isEmpty() ? 'disabled' : ''); ?>>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 sticky top-4">
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold"><?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($totalAmount))); ?> تومان</span>
                    </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold"><?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($remainingAmount))); ?> تومان</span>
                    </div>
                    <?php else: ?>
                    <div class="flex justify-between text-gray-700">
                        <span>سپرده:</span>
                        <span class="font-bold text-blue-600">بدون سپرده</span>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="border-t border-gray-200 pt-3 flex justify-between text-lg">
                        ...
                        <span class="font-black text-primary" id="final-total"><?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($totalAmount))); ?> تومان</span>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\checkout\auction.blade.php ENDPATH**/ ?>