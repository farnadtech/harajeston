    ...
    <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($gateways->count()); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600"><?php echo e($gateways->where('is_active', true)->count()); ?></p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-orange-600">
                            <?php echo e($gateways->filter(function($g) { return empty(array_filter($g->credentials ?? [])); })->count()); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                <!-- Gateway Header -->
                <div class="bg-gradient-to-r <?php echo e($gateway->is_active ? 'from-green-500 to-green-600' : 'from-gray-400 to-gray-500'); ?> p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-white"><?php echo e($gateway->display_name); ?></h3>
                                <p class="text-white/80 text-sm"><?php echo e($gateway->name); ?></p>
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="bg-gray-50 rounded-xl p-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-gray-900"><?php echo e($gateway->sort_order); ?></span>
                            </div>
                        </div>
                    </div>

                    <?php if($gateway->name === 'zarinpal' && $gateway->sandbox_mode): ?>
                    <!-- Sandbox Mode Badge -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/admin/payment-gateways/index.blade.php ENDPATH**/ ?>