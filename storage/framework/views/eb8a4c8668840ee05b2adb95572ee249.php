...
<?php $__env->startSection('title', 'ویرایش روش ارسال'); ?>
...
<div class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">ویرایش اطلاعات روش ارسال <?php echo e($shippingMethod->name); ?></p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form method="POST" action="<?php echo e(route('admin.shipping-methods.update', $shippingMethod)); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="description" 
                              rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary"
                              placeholder="توضیحات اختیاری درباره این روش ارسال"><?php echo e(old('description', $shippingMethod->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" 
                           name="base_cost" 
                           value="<?php echo e(old('base_cost', $shippingMethod->base_cost)); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary"
                           placeholder="50000"
                           min="0"
                           step="1000"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" 
                           name="estimated_days" 
                           value="<?php echo e(old('estimated_days', $shippingMethod->estimated_days)); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary"
                           placeholder="3"
                           min="1"
                           max="30">
                ...
                <div>
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" 
                               name="is_active" 
                               value="1"
                               <?php echo e(old('is_active', $shippingMethod->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\admin\shipping-methods\edit.blade.php ENDPATH**/ ?>