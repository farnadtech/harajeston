...
<head>
    ...
    <title>ایجاد حراجی جدید - <?php echo e(config('app.name')); ?></title>
...
<body class="bg-background-light text-[#0d121b] antialiased min-h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-white border-l border-gray-200 hidden lg:flex flex-col h-screen fixed right-0 top-0 z-30">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
            ...
            <a class="flex items-center gap-3 px-4 py-3 text-primary bg-primary/5 rounded-xl font-bold transition-colors" href="<?php echo e(route('listings.create')); ?>">
    ...
    <main class="flex-1 lg:mr-64 flex flex-col h-screen overflow-hidden relative w-full">
        ...
        <div class="flex-1 overflow-y-auto p-4 sm:p-8">
            <div class="max-w-4xl mx-auto">
                ...
                <form action="<?php echo e(route('listings.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="6" required
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
                                      placeholder="توضیحات کامل محصول، ویژگی‌ها، و نکات مهم را وارد کنید..."><?php echo e(old('description')); ?></textarea>
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/listings/create-new.blade.php ENDPATH**/ ?>