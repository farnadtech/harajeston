...
<body class="bg-gray-50 text-gray-900 antialiased min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-md p-8 sm:p-12">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-5">
            ...
            <div>
                <div class="flex items-center justify-between mb-1">
                    ...
                    <a class="text-xs font-bold text-primary hover:text-primary-hover" href="<?php echo e(route('password.request')); ?>">
                        فراموش کردید؟
                    </a>
                </div>
                <div class="relative">
        ...
        <div class="mt-6 text-center">
            ...
            <a class="text-sm font-bold text-primary hover:text-primary-hover mr-1" href="<?php echo e(route('register')); ?>">
                ثبت‌نام کنید
            </a>
        </div>

        <div class="mt-4 pt-4 border-t border-gray-100 text-center">
            <?php if(\App\Models\SiteSetting::get('otp_enabled', true)): ?>
            <a href="<?php echo e(route('otp.login')); ?>" class="text-sm text-gray-500 hover:text-primary font-medium flex items-center justify-center gap-1 transition-colors">
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\auth\login.blade.php ENDPATH**/ ?>