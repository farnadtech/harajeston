...
<body class="bg-background-light text-[#0d121b] antialiased min-h-screen flex overflow-hidden">
    ...
    <aside class="w-64 border-l border-gray-200 hidden lg:flex flex-col h-screen fixed right-0 top-0 z-30" style="background:<?php echo e(\App\Models\SiteSetting::get('theme_dashboard_sidebar_bg', '#ffffff')); ?>;">
        <div class="h-20 flex items-center gap-3 px-6 border-b border-gray-100">
            ...
            ?>
            <?php if($bLogo): ?>
                <img src="<?php echo e(url('storage/'.$bLogo)); ?>" class="h-10 w-auto object-contain" alt="<?php echo e($bText); ?>">
            <?php else: ?>
                <div class="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center text-primary">
                    <span class="material-symbols-outlined text-2xl"><?php echo e($bIcon); ?></span>
                </div>
            <?php endif; ?>
            <h1 class="text-xl font-black tracking-tight text-[#0d121b]"><?php echo e($bText); ?></h1>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
            ...
            <a class="flex items-center gap-3 px-4 py-3 text-gray-600 hover:text-primary hover:bg-gray-50 rounded-xl font-medium transition-colors group" href="<?php echo e(route('tickets.index')); ?>">
                ...
                ?>
                <?php if($buyerDashUnread > 0): ?>
                    <span class="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full mr-auto"><?php echo e($buyerDashUnread); ?></span>
                <?php endif; ?>
            </a>
    ...
    <main class="flex-1 lg:mr-64 flex flex-col h-screen overflow-hidden relative w-full">
        ...
        <div class="flex-1 overflow-y-auto p-4 sm:p-8">
            <?php if (isset($component)) { $__componentOriginalb69dd3e73304dd3354019ce94aa61f21 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb69dd3e73304dd3354019ce94aa61f21 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.verification-banner','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('verification-banner'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalb69dd3e73304dd3354019ce94aa61f21)): ?>
<?php $attributes = $__attributesOriginalb69dd3e73304dd3354019ce94aa61f21; ?>
<?php unset($__attributesOriginalb69dd3e73304dd3354019ce94aa61f21); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb69dd3e73304dd3354019ce94aa61f21)): ?>
<?php $component = $__componentOriginalb69dd3e73304dd3354019ce94aa61f21; ?>
<?php unset($__componentOriginalb69dd3e73304dd3354019ce94aa61f21); ?>
<?php endif; ?>
            <!-- Stats Cards -->
