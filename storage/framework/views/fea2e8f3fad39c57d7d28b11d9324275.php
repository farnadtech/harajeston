...
<body class="bg-background-light text-[#0d121b] antialiased min-h-screen flex overflow-hidden">
    ...
    <aside class="w-64 border-l border-gray-200 hidden lg:flex flex-col h-screen fixed right-0 top-0 z-30" style="background:<?php echo e(\App\Models\SiteSetting::get('theme_dashboard_sidebar_bg', '#ffffff')); ?>;">
        <div class="h-20 flex items-center gap-3 px-6 border-b border-gray-100">
            ...
            ?>
            <?php if($dLogo): ?>
                <img src="<?php echo e(url('storage/'.$dLogo)); ?>" class="h-10 w-auto object-contain" alt="<?php echo e($dText); ?>">
            <?php else: ?>
                <div class="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center text-primary">
                    <span class="material-symbols-outlined text-2xl"><?php echo e($dIcon); ?></span>
                </div>
            <?php endif; ?>
            <h1 class="text-xl font-black tracking-tight text-[#0d121b]"><?php echo e($dText); ?></h1>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
            ...
            <a class="flex items-center gap-3 px-4 py-3 <?php echo e(request()->routeIs('tickets.*') ? 'text-primary bg-primary/5 font-bold' : 'text-gray-600 hover:text-primary hover:bg-gray-50 font-medium'); ?> rounded-xl transition-colors group" href="<?php echo e(route('tickets.index')); ?>">
                ...
                <?php if($unreadTickets > 0): ?>
                    <span class="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full mr-auto"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($unreadTickets); ?></span>
                <?php endif; ?>
            </a>
