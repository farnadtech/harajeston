...
<?php $__env->startSection('title', 'مدیریت روش‌های ارسال'); ?>
...
<div class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <a href="<?php echo e(route('admin.shipping-methods.create')); ?>" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 flex items-center gap-2 text-sm font-medium">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">
                        <?php echo e(\App\Services\PersianNumberService::convertToPersian($shippingMethods->count())); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">
                        <?php echo e(\App\Services\PersianNumberService::convertToPersian($shippingMethods->where('is_active', true)->count())); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">
                        <?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($shippingMethods->avg('base_cost')))); ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $shippingMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-mono">
                            <?php echo e(\App\Services\PersianNumberService::convertToPersian($method->id)); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="text-sm font-bold text-gray-900"><?php echo e($method->name); ?></div>
                                    <?php if($method->description): ?>
                                        <div class="text-xs text-gray-500"><?php echo e(Str::limit($method->description, 40)); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-mono">
                            <?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($method->base_cost))); ?> تومان
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center gap-2">
                                ...
                                <button onclick="toggleStatus(<?php echo e($method->id); ?>, <?php echo e($method->is_active ? 'false' : 'true'); ?>)" 
                                        class="<?php echo e($method->is_active ? 'text-red-600 hover:text-red-800' : 'text-green-600 hover:text-green-800'); ?>" 
                                        title="<?php echo e($method->is_active ? 'غیرفعال کردن' : 'فعال کردن'); ?>">
                                    <span class="material-symbols-outlined text-[20px]">
                                        <?php echo e($method->is_active ? 'toggle_on' : 'toggle_off'); ?>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center text-gray-400">
                                ...
                                <a href="<?php echo e(route('admin.shipping-methods.create')); ?>" class="mt-4 text-primary hover:underline text-sm font-medium">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\admin\shipping-methods\index.blade.php ENDPATH**/ ?>