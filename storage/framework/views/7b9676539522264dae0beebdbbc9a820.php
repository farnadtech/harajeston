...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>خوش آمدید، <?php echo e(auth()->user()->name); ?></p>
        </div>

        <div class="stats">
            <div class="stat-card">
                <h3>درآمد کل</h3>
                <div class="value"><?php echo e(number_format($stats['total_sales'] ?? 0)); ?> تومان</div>
            </div>
            <div class="stat-card">
                <h3>مزایده‌های فعال</h3>
                <div class="value"><?php echo e($stats['active_auctions'] ?? 0); ?></div>
            </div>
            <div class="stat-card">
                <h3>در انتظار تایید</h3>
                <div class="value"><?php echo e($stats['pending_listings'] ?? 0); ?></div>
            </div>
            <div class="stat-card">
                <h3>تکمیل شده</h3>
                <div class="value"><?php echo e($stats['completed_auctions'] ?? 0); ?></div>
            </div>
        </div>

        <div class="table-container">
            <h2 style="margin-bottom: 20px;">مزایده‌های فعال</h2>
            <?php if(isset($activeListings) && $activeListings->count() > 0): ?>
                <table>
                    <thead>
                        <tr>
                            <th>عنوان</th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $activeListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(number_format($listing->current_price)); ?> تومان</td>
                                <td><?php echo e($listing->status); ?></td>
                                <td><?php echo e($listing->ends_at->diffForHumans()); ?></td>
                            </tr>
            ...
            <div style="margin-top: 20px;">
                <a href="<?php echo e(route('listings.create')); ?>" class="btn">افزودن مزایده جدید</a>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\dashboard\seller-minimal.blade.php ENDPATH**/ ?>