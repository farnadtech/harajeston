...
<div class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
    <!-- Header -->
    <div class="mb-6">
        <h2 class="text-2xl font-black text-gray-900">ویرایش دسته‌بندی: <?php echo e($category->name); ?></h2>
        <p class="text-sm text-gray-500 mt-1">ویرایش اطلاعات دسته‌بندی</p>
    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                    ...
                    <select name="parent_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary <?php $__errorArgs = ['parent_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                            ...
                            <optgroup label="<?php echo e($parent->name); ?>">
                                ...
                                <?php if($parent->children && count($parent->children) > 0): ?>
                                    <?php $__currentLoopData = $parent->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="<?php echo e($child->id); ?>" <?php echo e(old('parent_id', $category->parent_id) == $child->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\admin\categories\edit.blade.php ENDPATH**/ ?>