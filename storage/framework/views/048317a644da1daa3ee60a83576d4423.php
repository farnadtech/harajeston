...
<div class="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sticky top-6">
                ...
                <form method="GET" action="<?php echo e(route('listings.index')); ?>" class="space-y-4">
                    ...
                    <?php endif; ?>
                    <?php if(request('category_ids') && is_array(request('category_ids'))): ?>
                        <?php $__currentLoopData = request('category_ids'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input type="hidden" name="category_ids[]" value="<?php echo e($cid); ?>">
                ...
                ?>
                <a href="<?php echo e($clearUrl); ?>" class="block w-full mt-3 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-center font-medium">
                    حذف همه فیلترها
                </a>
                <?php endif; ?>
            </div>
                ...
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
                    <div>
                        <h1 class="text-2xl font-black text-gray-900 mb-2">
                            ...
                            <?php elseif(request('category_ids') && is_array(request('category_ids'))): ?>
                                <?php
                                    $catNames = \App\Models\Category::whereIn('id', request('category_ids'))->pluck('name')->implode('، ');
                                ?>
                                دسته‌بندی‌ها: <span class="text-primary"><?php echo e($catNames); ?></span>
                            <?php else: ?>
                                همه مزایده‌ها
                            <?php endif; ?>
                        </h1>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <select onchange="window.location.href=this.value" class="border-gray-300 rounded-lg text-sm focus:ring-primary focus:border-primary">
                            <option value="<?php echo e(request()->fullUrlWithQuery(['sort' => 'starting_soon'])); ?>" <?php echo e($normalizedSort == 'starting_soon' ? 'selected' : ''); ?>>
                                زودتر شروع می‌شود
                            </option>
                            <option value="<?php echo e(request()->fullUrlWithQuery(['sort' => 'ending_soon'])); ?>" <?php echo e($normalizedSort == 'ending_soon' || !request('sort') ? 'selected' : ''); ?>>
                                زودتر به پایان می‌رسد
                            </option>
                            <option value="<?php echo e(request()->fullUrlWithQuery(['sort' => 'newest'])); ?>" <?php echo e($normalizedSort == 'newest' ? 'selected' : ''); ?>>
                                جدیدترین
                            </option>
                            <option value="<?php echo e(request()->fullUrlWithQuery(['sort' => 'most_bids'])); ?>" <?php echo e($normalizedSort == 'most_bids' ? 'selected' : ''); ?>>
                                بیشترین پیشنهاد
                            </option>
                            <option value="<?php echo e(request()->fullUrlWithQuery(['sort' => 'price_high'])); ?>" <?php echo e($normalizedSort == 'price_high' ? 'selected' : ''); ?>>
                                بالاترین قیمت
                            </option>
                            <option value="<?php echo e(request()->fullUrlWithQuery(['sort' => 'price_low'])); ?>" <?php echo e($normalizedSort == 'price_low' ? 'selected' : ''); ?>>
                                پایین‌ترین قیمت
                            </option>
                        </select>
                    </div>
        ...
        <div class="flex flex-wrap items-center gap-2 pt-4 border-t border-gray-100">
            ...
            ?>
            <a href="<?php echo e($clearUrl); ?>" class="inline-flex items-center gap-1 px-3 py-1.5 bg-red-50 text-red-700 rounded-lg text-sm font-medium hover:bg-red-100 transition-colors">
