                    ...
                    <div class="mt-3 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-black text-primary mt-1">
                                <?php if($listing->bids->count() > 0): ?>
                                    <?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($listing->current_price))); ?>
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-lg font-bold text-gray-900 mt-1">
                                <?php echo e(\App\Services\PersianNumberService::convertToPersian($listing->bids->count())); ?> نفر
                            </p>
                        </div>
                    </div>
                </div>
