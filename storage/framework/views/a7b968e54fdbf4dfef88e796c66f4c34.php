    ...
    >
        ...
        <?php if($itemCount > 0): ?>
            <span class="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                <?php echo app(\App\Services\PersianNumberService::class)->toPersian($itemCount); ?>
            </span>
        <?php endif; ?>
    </button>
        ...
        <?php if($itemCount > 0): ?>
            <div class="p-4">
                ...
                <div class="space-y-2 mb-4 max-h-64 overflow-y-auto">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3 p-2 bg-gray-50 rounded">
                            <div class="flex-1">
                                <p class="font-medium text-sm"><?php echo e($item['listing']['title'] ?? 'محصول'); ?></p>
                                <p class="text-xs text-gray-600">تعداد: <?php echo app(\App\Services\PersianNumberService::class)->toPersian($item['quantity']); ?></p>
                            </div>
                            <p class="text-sm font-bold">
                                <?php echo app(\App\Services\PersianNumberService::class)->formatCurrency($item['price_snapshot'] * $item['quantity']); ?>
                            </p>
                        </div>
                ...
                <div class="border-t pt-3 mb-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-lg font-bold text-green-600">
                            <?php echo app(\App\Services\PersianNumberService::class)->formatCurrency($total); ?>
                        </span>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <a 
                        href="<?php echo e(route('checkout.show')); ?>"
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\livewire\cart-summary.blade.php ENDPATH**/ ?>