...
<div class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-black text-gray-900">جزئیات سفارش #<?php echo e($order->order_number); ?></h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <form action="<?php echo e(route('admin.orders.updateStatus', $order)); ?>" method="POST" class="mt-4">
                    ...
                    <div class="flex gap-3">
                        <select name="status" class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                            ...
                            <option value="shipped" <?php echo e($order->status === 'shipped' ? 'selected' : ''); ?>>در حال ارسال</option>
                ...
                <div class="space-y-4">
                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center border-b border-gray-200 pb-4 last:border-0 last:pb-0">
                            ...
                            <div class="flex-1">
                                <h4 class="font-medium text-gray-800 mb-1"><?php echo e($item->listing->title); ?></h4>
                                <p class="text-sm text-gray-600 mb-2">تعداد: <?php echo e(\App\Services\PersianNumberService::convertToPersian($item->quantity)); ?></p>
                                <p class="text-sm text-gray-500">
                                    قیمت واحد: <?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($item->price_snapshot))); ?> تومان
                                </p>
                            </div>
                            
                            <div class="text-left">
                                <p class="font-semibold text-gray-800">
                                    <?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($item->subtotal))); ?> تومان
                                </p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <form action="<?php echo e(route('admin.orders.updateShipping', $order)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="shipping_address" rows="3" 
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"><?php echo e($order->shipping_address); ?></textarea>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">شهر</label>
                                <input type="text" name="shipping_city" value="<?php echo e($order->shipping_city); ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">کد پستی</label>
                                <input type="text" name="shipping_postal_code" value="<?php echo e($order->shipping_postal_code); ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="shipping_phone" value="<?php echo e($order->shipping_phone); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between text-gray-700">
                        ...
                        <span><?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($order->subtotal))); ?> تومان</span>
                    </div>
                    <div class="flex justify-between text-gray-700">
                        <span>هزینه ارسال</span>
                        <span><?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($order->shipping_cost))); ?> تومان</span>
                    </div>
                    <div class="border-t border-gray-200 pt-3 flex justify-between font-semibold text-lg text-gray-800">
                        <span>مبلغ کل</span>
                        <span><?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($order->total))); ?> تومان</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <p class="font-medium text-gray-800"><?php echo e($order->buyer->name); ?></p>
                ...
                <?php if($order->buyer->phone): ?>
                    <div class="flex items-center text-gray-700">
                        ...
                        <span class="text-sm"><?php echo e(\App\Services\PersianNumberService::convertToPersian($order->buyer->phone)); ?></span>
                    </div>
                <?php endif; ?>
                <a href="<?php echo e(route('admin.users.show', $order->buyer)); ?>" 
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <p class="font-medium text-gray-800"><?php echo e($order->seller->name); ?></p>
                ...
                <?php if($order->seller->phone): ?>
                    <div class="flex items-center text-gray-700">
                        <i class="fas fa-phone ml-2 text-gray-400"></i>
                        <span class="text-sm"><?php echo e(\App\Services\PersianNumberService::convertToPersian($order->seller->phone)); ?></span>
                    </div>
                <?php endif; ?>
                <a href="<?php echo e(route('admin.users.show', $order->seller)); ?>" 
                   class="block mt-4 text-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200">
                    مشاهده پروفایل
                </a>
            </div>
                ...
                <div class="bg-red-50 border border-red-200 rounded-xl p-6">
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium"><?php echo e($order->cancelled_by === 'buyer' ? 'خریدار' : 'فروشنده'); ?></span>
                        </div>
                        <?php if($order->cancellation_penalty): ?>
                            <div class="flex justify-between">
                                <span class="text-red-700">جریمه:</span>
                                <span class="font-medium"><?php echo e(\App\Services\PersianNumberService::convertToPersian(number_format($order->cancellation_penalty))); ?> تومان</span>
                            </div>
                        <?php endif; ?>
                        <?php if($order->cancelled_at): ?>
                            <div class="flex justify-between">
                                <span class="text-red-700">تاریخ لغو:</span>
                                <span class="font-medium"><?php echo e(\App\Services\JalaliDateService::toJalali($order->cancelled_at, 'Y/m/d H:i')); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>