...
<body class="bg-gray-50 text-gray-900 antialiased min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-md p-8 sm:p-12">
        ...
        <form action="<?php echo e(route('otp.login.send')); ?>" method="POST" class="space-y-5">
            <?php echo csrf_field(); ?>
            <div>
        ...
        <div class="mt-6 pt-6 border-t border-gray-100 text-center">
            <a href="<?php echo e(route('login')); ?>" class="text-sm text-primary hover:text-primary-hover font-medium flex items-center justify-center gap-1">
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\auth\otp-login.blade.php ENDPATH**/ ?>