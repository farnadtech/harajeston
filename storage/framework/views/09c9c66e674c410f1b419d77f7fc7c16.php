...
<?php $__env->startSection('content'); ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-4">
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="?status=needs_approval" class="px-4 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request('status') === 'needs_approval' ? 'bg-orange-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                        در انتظار تایید ادمین (<?php echo app(\App\Services\PersianNumberService::class)->toPersian($counts['needs_approval'] ?? 0); ?>)
                    </a>
                    <a href="?status=pending" class="px-4 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request('status') === 'pending' ? 'bg-yellow-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                        در انتظار شروع (<?php echo app(\App\Services\PersianNumberService::class)->toPersian($counts['pending_start'] ?? 0); ?>)
                    </a>
