        ...
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-amber-900 mt-1"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($stats['pending']); ?></p>
                </div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-green-900 mt-1"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($stats['active']); ?></p>
                </div>
        ...
        <div class="bg-red-50 border border-red-200 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-red-900 mt-1"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($stats['suspended']); ?></p>
                </div>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-gray-900 mt-1"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($stats['rejected']); ?></p>
                </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 mb-6">
        <form method="GET" class="flex gap-4">
            ...
            <select name="status" class="border-gray-300 rounded-lg">
                <option value="all" <?php echo e($status === 'all' ? 'selected' : ''); ?>>همه</option>
                <option value="pending" <?php echo e($status === 'pending' ? 'selected' : ''); ?>>در انتظار</option>
                <option value="active" <?php echo e($status === 'active' ? 'selected' : ''); ?>>فعال</option>
                <option value="suspended" <?php echo e($status === 'suspended' ? 'selected' : ''); ?>>تعلیق</option>
            ...
            <?php if(request('search') || request('status') !== 'all'): ?>
                <a href="<?php echo e(route('admin.sellers.index')); ?>" class="bg-gray-100 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-200">
                    پاک کردن
                </a>
            <?php endif; ?>
        </form>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 text-sm"><?php echo app(\App\Services\PersianNumberService::class)->toPersian($seller->id); ?></td>
                    <td class="px-6 py-4">
                        <div class="font-bold text-gray-900"><?php echo e($seller->name); ?></div>
                        <div class="text-xs text-gray-500"><?php echo e($seller->email); ?></div>
                    </td>
                    <td class="px-6 py-4 text-sm">
                        <?php if($seller->store): ?>
                            <a href="<?php echo e(route('stores.show', $seller->store->slug)); ?>" 
                               class="text-primary hover:underline" target="_blank">
                                <?php echo e($seller->store->name); ?>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600">
                        <?php echo e(\Morilog\Jalali\Jalalian::fromDateTime($seller->seller_requested_at)->format('Y/m/d')); ?>
                    ...
                    <td class="px-6 py-4">
                        <a href="<?php echo e(route('admin.sellers.show', $seller)); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/admin/sellers/index.blade.php ENDPATH**/ ?>