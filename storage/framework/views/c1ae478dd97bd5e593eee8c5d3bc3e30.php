<div class="space-y-4">
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200">
                ...
                <div class="bg-white rounded-lg p-4 border border-blue-100">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-2xl font-black text-blue-600">
                            <?php echo app(\App\Services\PersianNumberService::class)->formatNumber($listing->required_deposit, true); ?> تومان
                        </span>
                    </div>
                    <p class="text-xs text-gray-500 mt-2">
                        (<?php echo e(\App\Services\PersianNumberService::convertToPersian(10)); ?>٪ از قیمت پایه)
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- __BLOCK__ --><?php if($hasParticipated): ?>
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/livewire/auction-participation.blade.php ENDPATH**/ ?>