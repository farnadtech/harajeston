    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div class="h-48 md:h-64 w-full bg-gradient-to-r from-blue-100 to-indigo-100 relative">
            <?php if($store->banner_url): ?>
                <img src="<?php echo e($store->banner_url); ?>" alt="بنر فروشگاه" class="w-full h-full object-cover">
            <?php endif; ?>
                ...
                <div class="w-32 h-32 rounded-2xl bg-white p-2 shadow-lg border border-gray-100 shrink-0 relative z-10">
                    <div class="w-full h-full rounded-xl bg-gray-50 flex items-center justify-center border border-gray-100 overflow-hidden">
                        <?php if($store->logo_url): ?>
                            <img src="<?php echo e($store->logo_url); ?>" alt="<?php echo e($store->store_name); ?>" class="w-full h-full object-cover">
                        <?php else: ?>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-4">
                        <div>
                            ...
                            <div class="flex items-center gap-4 mt-2 text-sm text-gray-500">
                                <span class="flex items-center gap-1">
                                    ...
                                    <span class="font-bold text-gray-900">
                                        <?php if($seller->seller_rating > 0): ?>
                                            <?php echo app(\App\Services\PersianNumberService::class)->toPersian(number_format($seller->seller_rating, 1)); ?>
                                        <?php else: ?>
                                            جدید
                                        <?php endif; ?>
                                    </span>
                                ...
                                <span><?php echo e($store->user->name); ?></span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div 
                    ...
                    x-show="filter === 'all' || (filter === 'buy_now' && <?php echo e($listing->hasBuyNowPrice() ? 'true' : 'false'); ?>) || (filter === 'ending' && <?php echo e($listing->ends_at && $listing->ends_at->diffInHours() < 24 ? 'true' : 'false'); ?>)"
