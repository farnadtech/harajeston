...
<body class="bg-background-light text-[#0d121b] antialiased min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-md p-8 sm:p-12">
        ...
        <div class="mt-6 text-center">
            <a class="text-sm font-bold text-primary hover:text-primary-hover flex items-center justify-center gap-2" href="<?php echo e(route('login')); ?>">
...
<?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>