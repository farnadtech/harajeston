...
<div class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('admin.listings.create')); ?>" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-blue-600 flex items-center gap-2 text-sm font-medium">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">
                        <?php echo e(\App\Services\PersianNumberService::convertToPersian(\App\Models\Listing::count())); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">
                        <?php echo e(\App\Services\PersianNumberService::convertToPersian(\App\Models\Listing::where('status', 'active')->count())); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">
                        <?php echo e(\App\Services\PersianNumberService::convertToPersian(\App\Models\Listing::whereDate('created_at', today())->count())); ?>
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select name="type" class="w-full border-gray-300 rounded-lg text-sm focus:ring-primary focus:border-primary">
                    ...
                    <option value="auction" <?php echo e(request('type') === 'auction' ? 'selected' : ''); ?>>مزایده</option>
                    <option value="direct_sale" <?php echo e(request('type') === 'direct_sale' ? 'selected' : ''); ?>>فروش مستقیم</option>
                    <option value="both" <?php echo e(request('type') === 'both' ? 'selected' : ''); ?>>ترکیبی</option>
                </select>
            </div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo e(route('admin.listings.index')); ?>" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 text-sm font-medium">
                    پاک کردن
                </a>
            </div>
        </form>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500">شناسه: <?php echo e(\App\Services\PersianNumberService::convertToPersian($listing->id)); ?></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="<?php echo e(route('admin.users.show', $listing->seller)); ?>" class="text-sm text-primary hover:underline">
                                <?php echo e($listing->seller->name); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center gap-2">
                                ...
                                <?php if($listing->status === 'draft'): ?>
                                    ...
                                    <button onclick="rejectListing('<?php echo e($listing->slug); ?>')" 
                                ...
                                <?php if($listing->status === 'pending'): ?>
                                    <button onclick="activateListing('<?php echo e($listing->slug); ?>')" 
                                            class="text-green-600 hover:text-green-800" 
                                            title="فعال‌سازی">
                                ...
                                <?php if($listing->status === 'active'): ?>
                                    <button onclick="suspendListing('<?php echo e($listing->slug); ?>')" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp8.1\htdocs\haraj\resources\views/admin/listings/index.blade.php ENDPATH**/ ?>