...
<body class="bg-background-light text-[#0d121b] antialiased min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-md p-8 sm:p-12">
        ...
        <div class="mb-8">
            ...
            <h2 class="text-2xl font-bold text-gray-900 mb-2 text-center">فراموشی رمز عبور</h2>
            <p class="text-sm text-gray-500 text-center">ایمیل خود را وارد کنید تا لینک بازیابی رمز عبور برای شما ارسال شود</p>
        </div>
        
        @if(session('status'))
            <div class="bg-green-50 border-r-4 border-green-500 rounded-lg p-4 mb-6">
                <div class="flex items-start">
                    <span class="material-symbols-outlined text-green-500 ml-3">check_circle</span>
