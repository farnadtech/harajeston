                ...
                <div class="mb-6 border-t pt-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" 
                               ...
                               value="{{ $walletSettings['charge_tax'] ?? 0 }}"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                               min="0"
                               max="100"
                               step="0.1">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input type="radio" name="order_cancellation_penalty_type" value="percentage" 
                                   {{ (\App\Models\SiteSetting::get('order_cancellation_penalty_type', 'percentage') === 'percentage') ? 'checked' : '' }}
                                   class="ml-2">
                            <span>درصد از مبلغ سفارش</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="order_cancellation_penalty_type" value="fixed" 
                                   {{ (\App\Models\SiteSetting::get('order_cancellation_penalty_type', 'percentage') === 'fixed') ? 'checked' : '' }}
                                   class="ml-2">
                            <span>مبلغ ثابت</span>
                        </label>
                    </div>
